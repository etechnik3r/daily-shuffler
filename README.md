...
- **Vier Anzeigemodi:** Klassische Liste, animierte Slotmaschine, Roadtrip-Ansicht mit E-Auto oder das bunte Glücksrad (siehe unten).
...
In den Einstellungen wählst du zwischen vier Darstellungen:
...
- **Anzeigemodus:** Klassisch, Slotmaschine, Roadtrip (E-Auto) oder Glücksrad.
